...
NAME := re-cfg-seed
SHORTNAME := recfgseed
TESTPACKAGE := recfgseed

RPMSPECDIR := ./contrib/rpm/
RPMSPEC := $(RPMSPECDIR)/re-cfg-seed.spec
...
pep8:
	...
	@echo "#############################################"
	pep8 --ignore=E501,E121,E124 src/
...
srpm: rpmcommon
	...
	@find rpm-build -maxdepth 2 -name 're-cfg-seed*src.rpm' | awk '{print "    " $$1}'
	@echo "#############################################"
...
rpm: rpmcommon
	...
	@find rpm-build -maxdepth 2 -name 're-cfg-seed*.rpm' | awk '{print "    " $$1}'
	@echo "#############################################"
